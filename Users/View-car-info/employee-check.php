...
$find_cars= "SELECT * FROM car WHERE availability = 'booked'";
 $query = mysqli_query($con,$find_cars);

 if (mysqli_num_rows($query) >= 1){
?>

    
<h1 class="mt-4 pt-4">Car delivery</h1>
       

<div class="card my-2 shadow-sm" style="max-width: 28rem;">
<div class="card-header">Needs to be delivered</div>
    ...
    <div class="d-grid mb-3 mx-3">
        <a href="./../../Admin/Manage-booking/delivered.php" class="btn btn-primary">I've delivered this</a>
    </div>
</div>
...
<div class="my-4 py-4">
<h6 class="my-4 text-muted">No cars to be delivered yet...</h6>
