				...
				<div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
					...
					<div class="card rounded-3 shadow">
						<div class="card-body p-5">
							...
							<h4 class="fs-4 card-title fw-bold mb-4">You're one step closer to renting a car</h4>
							<form method="POST" class="needs-validation" action="./success.php" novalidate="" autocomplete="off">
						...
						<div class="card-footer py-3 border-0">
							<div class="text-center">
								Already own an account? <a href="./../Login" class="text-dark">Log in</a>
							</div>
						</div>
					</div>
